...
exports.Inbox = exports.Email = exports.TempMail = void 0;
...
class TempMail {
    ...
    async makeRequest(url, post_data, method) {
        let headers = {
        ...
        const raw = await (0, node_fetch_1.default)(BASE_URL + url, {
            headers,
     ...
     */
    async checkInbox(authentication) {
        const token = authentication instanceof Inbox_1.default ? authentication.token : authentication;
     ...
     */
    async checkCustomDomainLegacy(domain, token) {
        const raw = (await (0, node_fetch_1.default)(`https://api.tempmail.lol/custom/${token}/${domain}`, {
            headers: {
     ...
     */
    async checkV2CustomDomain(domain) {
     ...
     */
    async setPrivateDomainWebhook(domain, webhook_url) {
     ...
     */
    async deletePrivateDomainWebhook(domain) {
